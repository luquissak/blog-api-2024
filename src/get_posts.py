            ...
            if "items" in posts_doc and not (posts_doc["items"] is None):
                for post in posts_doc["items"]:
                    ...
                    if year == "2013":
                        ...
                        add_hyperlink(p, post["title"], post["url"])
                        document_2013.add_paragraph(html2text.html2text(post["content"])+"\n")
                        document_2013.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2014":
                        ...
                        document_2014.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2015":
                        ...
                        document_2015.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2016":
                        ...
                        document_2016.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2017":
                        ...
                        document_2017.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2018":
                        ...
                        document_2018.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2019":
                        ...
                        document_2019.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2020":
                        ...
                        document_2020.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2021":
                        ...
                        document_2021.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2022":
                        ...
                        document_2022.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2023":
                        ...
                        document_2023.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2024":
                        ...
                        document_2024.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2025":
                        ...
                        document_2025.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    elif year == "2026":
                        ...
                        document_2026.save('docao4/Reflexoes_'+str(year)+'_posts_content.docx')
                    else:
                        print("DEU RUIM")
#                    continue
                    if i > 3: exit()
                    ...
                    document.save('docao4/Reflexoes_posts_content.docx')
                    i = i + 1
